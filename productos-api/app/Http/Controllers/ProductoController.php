...
class ProductoController extends Controller
{
    ...
    /**
     * Mostrar un producto específico (GET /api/productos/{id})
     */
    ...
    /**
     * Actualizar completamente un producto (PUT /api/productos/{id})
     */
    ...
    /**
     * Actualizar parcialmente un producto (PATCH /api/productos/{id})
     */
